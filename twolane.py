...
for i in range(1+circle):
    ...
    if i % 10 == 0 and i >= 40000:
        for car in Car1:
            f1.write(str(i)+' '+str(car.Num)+' '+str(car.Pos[tao])+' '+str(car.Headway[tao])+' '+str(car.Spd[tao])+' '+str(car.Acc[tao])+'\n')
            # lane1.LaneChange(i, lane1, lane2, car)
        for car in Car2:
            f2.write(str(i)+' '+str(car.Num)+' '+str(car.Pos[tao])+' '+str(car.Headway[tao])+' '+str(car.Spd[tao])+' '+str(car.Acc[tao])+'\n')
